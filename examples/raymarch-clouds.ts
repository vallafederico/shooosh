 ...
 */
import shader, { fragment } from "./raymarch-clouds.wgsl"
...
export const raymarchClouds: ExampleSpec = {
  id: "raymarch-clouds",
  label: "Raymarch clouds",
  copy: "Fly through sunlit volumetric clouds with gentle camera drift and nearby wisps passing around you.",
  fragment,
