...
Docs that are not a queue item: [shader contract](../shader-contract.md), [translation](../shader-translation.md), [API](../api.md), [site patterns](../site-patterns.md). Skills live in `.cursor/skills/`.
