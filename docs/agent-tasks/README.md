...
Docs that are not a queue item: [getting started](../getting-started.md), [shader contract](../shader-contract.md), [translation](../shader-translation.md), [API](../api.md), [site patterns](../site-patterns.md), [MSDF generators](../msdf.md), [examples](../../examples/README.md). Skills live in `.cursor/skills/`.
